...
const AuctionActive = ({ navigation }) => {
    ...
    const getAllAuctions = async () => {
        try {
            ...
            setLoading(false); // Actualizar el estado loading una vez que todas las operaciones hayan finalizado
                ...
                >
                    {auctions.map((auction, index) => (
                        <ShowMyActiveAuctions
                            key={index} // Asegúrate de proporcionar una prop 'key' única
                            auction={auction}
